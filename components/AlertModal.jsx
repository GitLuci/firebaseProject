...
const AlertModal = ({modalVisible, setModalVisible}) => {
  ...
  console.log(userSelected)
  const [Alert_ModalOpen, Alert_setIsModalOpen] = useState(false);

  const createAlert = () =>{
    Alert_setIsModalOpen(true);

  }

  const createAlertAll = () =>{
...
const renderItem = ({ item }) => (
  ...
  >
    <View style={styles.centeredView}>
      ...
      <CreateAlert modalVisible={Alert_ModalOpen} setModalVisible={Alert_setIsModalOpen}/>

          <TouchableHighlight
            style={{ ...styles.openButton, backgroundColor: "#2196F3" }}
            onPress={createAlert}>
            <Text style={styles.textStyle}>All Workes</Text>
          </TouchableHighlight>
